...
const apiAction = (() => {
  ...
  const declareData = ([forecast, current, air]) => {
    ...
    const sunrise = (0,_utility__WEBPACK_IMPORTED_MODULE_1__.time)(forecast.city.sunrise, timezone);
    const sunset = (0,_utility__WEBPACK_IMPORTED_MODULE_1__.time)(forecast.city.sunset, timezone);
